AcquaRush.GameOver = {
    create: function() {
        ...
        this.again = game.add.sprite(670, 260, 'again');
	    game.add.tween(this.again).from( { y: -200 }, 2000, Phaser.Easing.Bounce.Out, true);
        this.menu = game.add.sprite(370, 260, 'menu');
        game.add.tween(this.menu).from( { y: -200 }, 2000, Phaser.Easing.Bounce.Out, true);    
        this.scoreDistance = game.add.text(440, 150, 'BEST DISTANCE:' + game.scores.distance , style);    
